...
public class RefRatingSubtotalType {
	...
	public RefRatingSubtotalType(ResultSet rs) {
		try {
			...
			isBillingSubtotal=rs.getInt("is_billing_subtotal");
	...
	public int getIsBillingSubtotal() {
		return isBillingSubtotal;
	}

	public void setIsBillingSubtotal(int isBillingSubtotal) {
		this.isBillingSubtotal = isBillingSubtotal;
	}
}
