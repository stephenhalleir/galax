...
public class ChargedUsagePrepay {

	private int id;
	private Date lastModifiedDateTime;
	private int mobileUsagePrepayId;
	private int amount;
	...
	public ChargedUsagePrepay() {

	}

	public ChargedUsagePrepay(ResultSet rs) {
		try {
			id = rs.getInt("id");
			lastModifiedDateTime = rs.getDate("last_modified_date_time");
			mobileUsagePrepayId = rs.getInt("mobile_usage_prepay_id");
	...
	public int getMobileUsagePrepayId() {
		return mobileUsagePrepayId;
	}

	public void setMobileUsagePrepayId(int mobileUsagePrepayId) {
		this.mobileUsagePrepayId = mobileUsagePrepayId;
	}
