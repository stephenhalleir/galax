...
public class ChargedUsageB2b {

	private int id;
	private Date lastModifiedDateTime;
	private int mobileUsageB2bId;
	private int amount;
	...
	public ChargedUsageB2b() {

	}

	public ChargedUsageB2b(ResultSet rs) {
		try {
			id = rs.getInt("id");
			lastModifiedDateTime = rs.getDate("last_modified_date_time");
			mobileUsageB2bId = rs.getInt("mobile_usage_b2b_id");
	...
	public int getMobileUsageB2bId() {
		return mobileUsageB2bId;
	}

	public void setMobileUsageB2bId(int mobileUsageB2bId) {
		this.mobileUsageB2bId = mobileUsageB2bId;
	}
