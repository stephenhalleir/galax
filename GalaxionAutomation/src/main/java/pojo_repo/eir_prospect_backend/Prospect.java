...
try {
	...
	csrAgentEmail = rs.getString("csr_agent_email");
...
public String getCsrAgentEmail() {
 	return csrAgentEmail;
}
public void setCsrAgentEmail(String csrAgentEmail) {
 	 this.csrAgentEmail=csrAgentEmail;
}
