...
public class QrtzSimpropTriggersOld {
...
private int boolProp2;

public QrtzSimpropTriggersOld() {

}

public QrtzSimpropTriggersOld(ResultSet rs) {
try {
	...
	boolProp2 = rs.getInt("BOOL_PROP_2");
...
public int getBoolProp2() {
 	return boolProp2;
}
public void setBoolProp2(int boolProp2) {
