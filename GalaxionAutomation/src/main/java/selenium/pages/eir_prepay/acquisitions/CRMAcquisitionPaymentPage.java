...
public class CRMAcquisitionPaymentPage {
	...
	// Constructor
	public CRMAcquisitionPaymentPage(WebDriver driver) {
		this.driver = driver;
	...
	public void enterDetailsAndPay(String cardNumber, String expiry, String ccv, String cardHolder) {
       ...
       // wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id='targetIframe']")));
		...
		wait.until(ExpectedConditions.frameToBeAvailableAndSwitchToIt("target-iframe"));
	...
	public String getOrderNumber() {
		WebElement txtConfirmationMessage=driver.findElement(By.xpath("/html/body/div[3]/div[3]/div/div[2]/div/p[2]"));
		wait.until(ExpectedConditions.visibilityOf(txtConfirmationMessage));
